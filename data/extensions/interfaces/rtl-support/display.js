...
var _default = {
  ...
  computed: {
    ...
    displayValue: function displayValue() {
      ...
      var shortInput = this.value.length > 200 ? this.value.slice(0, 200) : this.value;
...
exports.default = _default;
        var $7a770c = exports.default || module.exports;
      
      if (typeof $7a770c === 'function') {
        $7a770c = $7a770c.options;
      }
    
        /* template */
        Object.assign($7a770c, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7a770c', $7a770c);
          } else {
            api.reload('$7a770c', $7a770c);
          }
        }
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","display.vue"], "__DirectusExtension__")
